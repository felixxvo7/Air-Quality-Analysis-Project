...
## -----------------------------------------------------------------------------------------------------------
table(aqi_trend$AQI_Category, aqi_trend$Season)

aqi_trend$AQI_Category = factor(aqi_trend$AQI_Category, 
                                levels = rev(aqi_breakpoints$Category), 
                                ordered = TRUE)

ggplot(aqi_trend, aes(x = Season, fill = AQI_Category)) +
